...
pub fn open_image(path: &str) -> Option<DynamicImage> {
...
mod tests {
    ...
    #[test]
    fn test_apply_orientation_noop() {
        let img = image::DynamicImage::ImageRgb8(image::RgbImage::new(10, 20));
    ...
    #[test]
    fn test_read_exif_orientation_nonexistent() {
        let orientation = read_exif_orientation("/nonexistent/file.jpg");
